...
class _ForgotState extends State<Forgot> {
  ...
  Future<Null> _focusNodeListener() async {
    ...
    if (!_focusNodeCheckCode.hasFocus && !_focusNodeEmail.hasFocus) {
      // if (_email == null) {
      //   _alertDialog('邮箱不能为空');
      // }if (_myCode == null) {
      //   _alertDialog('验证码不能为空');
      // }
    }
  }
                  ...
                  new Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: "邮箱",
                        hintStyle: TextStyle(fontSize: ScreenUtil().setSp(50)),
                        prefixIcon: Icon(
                          IconFont.email,
                          size: 20,
                        ),
